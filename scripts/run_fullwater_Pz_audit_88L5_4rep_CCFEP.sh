...
WORK=${ROOT}/analysis_fullwater_Lz_Pz_20260824
PY=/lustre/home/users/ewu/.conda/envs/HB_analysis/bin/python
mkdir -p "${WORK}/fullwater_Lz_Pz_88L5_4rep"
cd "${WORK}"
"${PY}" audit_fullwater_orbital_Lz.py \
  ...
  --output "${WORK}/fullwater_Lz_Pz_88L5_4rep" --stride 10
printf 'CCFEP full-water Lz/Pz audit finished successfully.\n' > "${WORK}/fullwater_Lz_Pz_88L5_4rep/PBS_FINISHED.txt"
